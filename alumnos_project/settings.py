...
# Configuración de DEBUG - True solo si existe la variable y es 'True'
...
# Base de datos por defecto (SQLite para desarrollo local)
DATABASES = {
    'default': {
...
# Storage backend para static files
